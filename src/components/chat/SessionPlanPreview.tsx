    ...
    <div className="mt-4 border border-border-card rounded-lg p-4 bg-bg-primary">
      ...
      <div className="flex gap-4 mb-4 pb-4 border-b border-border-card">
        <div className="flex-1 text-center">
          <div className="text-2xl font-bold text-white">{plan.budgetMinutes}m</div>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 bg-accent-yellow text-black font-bold py-3 px-4 rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="bg-bg-card border border-border-card text-white font-semibold py-3 px-4 rounded-lg hover:bg-bg-card-hover transition-colors"
        >
          Change Time
        </button>
      </div>
