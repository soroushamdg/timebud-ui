    ...
    <div className="fixed inset-0 bg-black/70 z-[100] flex items-end" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center justify-center gap-6 text-sm">
          <button onClick={() => goTo('/v1/tasks/new')} className="text-text-sec hover:text-white transition-colors">
            Full task form
          </button>
          <button onClick={() => goTo('/v1/projects/new')} className="text-text-sec hover:text-white transition-colors">
            New project
          </button>
        </div>
      </div>
