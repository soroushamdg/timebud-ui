...
// ... (rest of the code remains the same)
  ...
  const handleTaskClick = (task: PlannedTask) => {
    if (task.projectId) {
      ...
      router.push(`/v1/projects/${task.projectId}?taskId=${task.taskId}`);
    }
  };
      ...
      <div className="flex flex-col h-[calc(100vh-5rem)] pb-5 overflow-visible">
        ...
        <div className="flex-shrink-0">
          ...
          <div className="px-6 pt-4 mb-6 flex items-center justify-between">
            <button
              onClick={() => router.push("/v1/profile")}
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => router.push("/v1/tasks/all")}
          ...
          <div className="mb-6 overflow-visible">
            <div className="flex items-center justify-between mb-2 px-6">
              ...
              <button
                onClick={() => router.push("/v1/projects/select")}
            ...
            {!projects || projects.length === 0 ? (
              ...
              <div className="flex gap-4 overflow-x-auto pb-2 pt-6 scrollbar-hide px-6">
                {sortedProjects.map((project) => (
                  <button
                    key={project.id}
                    onClick={() => router.push(`/v1/projects/${project.id}`)}
